...
const ShopDetail: NextPage<Props> = ({ product, productsData }) => {
  return (
    <>
      <Head>
      ...
      <RelatedProducts arr={productsData} />
    </>
  );
};
...
export const getStaticProps: GetStaticProps = async ({ params }) => {
  ...
  const getRandomNumber = randomNumber(0, 10);

  const productsRes = await fetch(
    `http://localhost:5001/products?_start=${getRandomNumber}&_limit=4`
  );
